...
app.config["SECRET_KEY"] = "HC_TESTING"
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///ncms.db"
db = SQLAlchemy(app)
...
class User(db.Model, UserMixin):
    ...
    dashboard = db.Column(db.String(192), nullable=True)
